# useful links
- [XSens ROS2 MTI DRIVER](https://github.com/leonardonels/Xsens_MTi_ROS2_Driver_and_Ntrip_Client.git)
- [HesaiLidar ROS 2.0 DRIVER](https://github.com/leonardonels/HesaiLidar_ROS_2.0.git)
    remember to use `git submodules update --init` after download
...
- [Bags_alt](https://drive.google.com/drive/folders/1XP3lOW1AS15QlEyR_MPKyaI0VNsc3VF8?usp=drive_link)
